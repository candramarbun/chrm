...
@section('content')
	<div class="box box-info">
       ...
       {!! Form::model($project, ['method' => 'PATCH','route' => ['project_update', $project->id],'role'=>'form' ]) !!}
        <div class="box-body">
            ...
            <div class="form-group">
             ...
             {!! Form::label('level', 'Status:', ['class' => 'control-label']) !!}
                <div class="radio">
                    <label>{!! Form::radio('status', 'ongoing') !!} Ongoing</label>
                </div>
                <div class="radio">
                    <label>{!! Form::radio('status', 'closed') !!} Closed</label>
                </div>
                </div>
        </div>
            <!-- /.box-body -->
